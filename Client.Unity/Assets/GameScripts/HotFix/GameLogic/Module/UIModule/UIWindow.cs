...
namespace GameLogic
{
    public abstract class UIWindow : UIBase
    {
        ...
        private void Handle_Completed(GameObject panel)
        {
            ...
            _panel = panel;
            NormalizeWindowRect(_panel.transform);
        ...
        private static void NormalizeWindowRect(Transform windowTransform)
        {
            ...
            if (windowTransform is not RectTransform rectTransform)
            {
                return;
            }
