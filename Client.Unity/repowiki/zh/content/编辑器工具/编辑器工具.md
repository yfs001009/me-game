...
graph TB
subgraph "HtmlToUGUI"
CFG["HtmlToUGUIConfig<br/>分辨率与DSL模板"]
BKR["HtmlToUGUIBaker<br/>烘焙器窗口"]
end
...
sequenceDiagram
participant U as "用户"
participant W as "HtmlToUGUIBaker"
participant J as "JSON数据"
participant C as "Canvas"
participant N as "节点树"
participant G as "UGUI组件"
U->>W : 打开窗口并设置配置
U->>W : 选择目标Canvas
U->>W : 选择输入模式(文件/字符串)
U->>W : 提交“执行烘焙生成”
...
```mermaid
graph LR
BKR["HtmlToUGUIBaker"] --> CFG["HtmlToUGUIConfig"]
BKR --> UI["UGUI组件库"]
